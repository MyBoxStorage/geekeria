...
export default function CheckoutSuccess() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-fire/10 via-fire/5 to-cosmos/10 p-4">
        ...
        <CardContent className="p-6 sm:p-8 text-center">
          ...
          <div className="mb-6">
            <div className="relative inline-flex items-center justify-center">
              <div className="absolute inset-0 bg-fire/20 rounded-full animate-ping" style={{ animationDuration: '2s' }} />
              <CheckCircle className="w-20 h-20 sm:w-24 sm:h-24 text-success relative z-10" />
            </div>
          </div>
          ...
          {/* Subtítulo */}
          <p className="text-base sm:text-lg text-cosmos/70 mb-6 sm:mb-8 font-body">
            Seu pedido foi confirmado. Voce pode acompanhar o status a qualquer momento.
          </p>

          {/* Badge de Status Aprovado */}
          <div className="mb-6">
            <span className="inline-flex items-center gap-2 bg-fire/15 text-fire border border-fire/30 rounded-full px-4 py-2 text-sm font-medium">
          ...
          {loading ? (
            ...
            <>
              ...
              {resolvedRef && (
                <div className="bg-gradient-to-r from-fire/10 to-fire/5 rounded-xl p-5 sm:p-6 mb-6 border border-fire/30 hover:shadow-lg transition-shadow duration-300">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <div className="w-8 h-8 bg-fire/10 rounded-full flex items-center justify-center">
                      <Package className="w-4 h-4 text-fire" />
                    </div>
                    <p className="text-sm font-medium text-fire font-body">Referencia do pedido</p>
                  </div>
              ...
              {!loading && resolvedRef && !order && (
                <div className="text-sm text-cosmos bg-cosmos/10 border border-cosmos/30 rounded-xl p-4 mb-4 font-body">
              ...
              <div className="mb-6 p-4 sm:p-5 bg-fire/5 rounded-xl border border-fire/20">
                <p className="text-sm text-fire font-body leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <Link to="/minha-conta" className="block">
              <Button
                className="w-full border-2 border-cosmos text-cosmos hover:bg-cosmos hover:text-white rounded-lg transition-all duration-300"
                size="lg"
                variant="outline"
              >
